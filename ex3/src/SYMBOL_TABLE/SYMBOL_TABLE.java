...
public class SYMBOL_TABLE
{
	...
	/* joe's edit: tries to find in the same scope, works for global scope too*/

	public TYPE find_in_curr_scope(String name)
	{
		SYMBOL_TABLE_ENTRY top_of_table=top;
		//System.out.println(name);
		while ( top_of_table!= null && top_of_table.name != "SCOPE-BOUNDARY" )
		{
			if (name.equals(top_of_table.name))
			{
				return top_of_table.type;
			}
			top_of_table = top_of_table.prevtop;
		}
	...
	public void printERROR(int line) {
		...
		try
		{
			PrintWriter pw = new PrintWriter(dirname+filename);
			String msg = String.format("ERROR(%d)", line);
			pw.print(msg);
			pw.close();
	...
	public static SYMBOL_TABLE getInstance()
	{
		if (instance == null)
		{
			...
			/***************************************/
			instance.enter("PrintInt",new TYPE_FUNCTION(
					TYPE_VOID.getInstance(),
					"PrintInt",
					new TYPE_LIST(TYPE_INT.getInstance(),null))
					);
			
			instance.enter("PrintString",new TYPE_FUNCTION(
					TYPE_VOID.getInstance(),
					"PrintString",
					new TYPE_LIST(TYPE_STRING.getInstance(),null))
					);
			
			instance.enter("PrintTrace",new TYPE_FUNCTION(
					TYPE_VOID.getInstance(),
					"PrintTrace",
					null)
					);
